...
class OpenAIService:
    ...
    async def generate_public_figure_prompts(self, figure: str) -> List[str]:
        ...
        user_prompt = (
            ...
            f"generate exactly 8 natural search queries consumers would ask AI assistants.\n\n"
            f"IMPORTANT RULES:\n"
            f"- The FIRST 5 queries should be specifically about '{figure}' (background, achievements, controversies, comparisons, opinions)\n"
            f"- The LAST 3 queries MUST be broader questions about their field/industry/domain that do NOT mention '{figure}' by name at all.\n"
            f"  These should be generic category questions where '{figure}' might naturally come up in the answer.\n"
            f"  Examples for Alexandria Ocasio-Cortez: 'who are the most important congress people right now', 'most influential progressive politicians', 'young leaders in US politics'\n"
